        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-4 font-light">
              Get in Touch with School of Social Change
            </p>
            <p className="text-lg max-w-3xl mx-auto">
              We&apos;d love to hear from you. Reach out to us for partnerships, collaborations, or to learn more about addressing education mortality.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    >
                      dexter@schoolofsocialchange.org
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    href="https://linkedin.com/company/sosc"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-brand-primary text-white rounded-lg flex items-center justify-center hover:bg-brand-primary-800 transition-colors"
                    aria-label="LinkedIn"
                  ...
                  <a
                    href="https://instagram.com/sosc_official"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-brand-primary text-white rounded-lg flex items-center justify-center hover:bg-brand-primary-800 transition-colors"
                  ...
                  <a
                    href="https://facebook.com/sosc.official"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-brand-primary text-white rounded-lg flex items-center justify-center hover:bg-brand-primary-800 transition-colors"
                    aria-label="Facebook"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Located in Mogappair ERI, Chennai - easily accessible by public transport
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="aspect-w-16 aspect-h-9 h-96">
              <iframe
                ...
                title="School of Social Change Office Location"
              ></iframe>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-brand-primary text-white rounded-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-lg">
                We&apos;re here to help you address education mortality
              </p>
            </div>
