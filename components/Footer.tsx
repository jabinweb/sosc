      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-16 gap-y-8">
          ...
          <div className="w-full flex flex-col space-y-6">
            <div className="">
              <Image src="/logos/sosc_logo_yellow.svg" alt="School of Social Change Logo" width={150} height={50} />
            </div>
            <div className="space-y-2 text-sm text-gray-300">
              <div className="flex items-center">
                ...
                <span>H14, Parkview Apartments<br />Mogappair ERI, Chennai 600 037</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2 text-brand-primary flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-full">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/get-involved" className="text-gray-300 hover:text-brand-primary transition-colors duration-300 text-sm">
                  Get Involved
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 School of Social Change. All rights reserved.
          </p>
